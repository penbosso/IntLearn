...
export default function QuizComponent({ questions }: { questions: Question[] }) {
  ...
  const options = currentQuestion.options ?? (currentQuestion.type === 'True/False' ? ['True', 'False'] : []);
  ...
  return (
    <Card className="w-full max-w-2xl">
      ...
      <CardContent>
        <p className="text-lg font-semibold mb-6 min-h-[3em]">{currentQuestion.question}</p>
